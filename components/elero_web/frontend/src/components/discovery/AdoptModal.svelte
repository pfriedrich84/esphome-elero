<script>
  import { adoptTarget, adoptName, adoptType, confirmAdopt } from '../../lib/stores.svelte.js'

  function close() { adoptTarget = null }
</script>
    ...
    <div class="relative w-full max-w-md mx-4 bg-white rounded-lg shadow-xl dark:bg-gray-800">
      ...
      <div class="flex items-center justify-between p-4 border-b dark:border-gray-700">
        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
          Adopt blind <span class="font-mono">{adoptTarget.blind_address}</span>
        </h3>
      ...
      <div class="p-4 space-y-4">
        <div>
          ...
          <input type="text" bind:value={adoptName} placeholder="e.g. Balcony"
